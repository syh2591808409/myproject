...
public class NewsCategoryController {
    ...
    public String newsCategoryManage(NewsCategory newsCategory, @PathVariable Integer pageCurrent, @PathVariable Integer pageSize, @PathVariable Integer pageCount, Model model,@RequestParam("userName") String userName) {
        ...
        String pageHTML = PageUtil.getPageContent("newsCategoryManage_{pageCurrent}_{pageSize}_{pageCount}?userName="+userName+"&name"+newsCategory.getName(), pageCurrent, pageSize, pageCount);
    ...
    public String newsCategoryEditGet(Model model,NewsCategory newsCategory,@RequestParam("userName")String userName) {
    ...
    public String newsCategoryEditPost(Model model,NewsCategory newsCategory, @RequestParam MultipartFile[] imageFile,HttpSession httpSession) {
        ...
        return "redirect:newsCategoryManage_0_0_0"+"?userName="+adminRes.getUserName();
    }
